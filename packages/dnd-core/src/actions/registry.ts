...
export const ADD_SOURCE = '@slite/react-dnd-core/ADD_SOURCE'
export const ADD_TARGET = '@slite/react-dnd-core/ADD_TARGET'
export const REMOVE_SOURCE = '@slite/react-dnd-core/REMOVE_SOURCE'
export const REMOVE_TARGET = '@slite/react-dnd-core/REMOVE_TARGET'
